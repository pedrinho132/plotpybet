...
export default function Relatorios({ route, navigation }) {
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity onPress={() => navigation.navigate('RelatorioDoMes', { nomeMes: item.key })} style={{ height: 100, marginTop: 18, width: 220, borderWidth: 1, borderColor: 'black', backgroundColor: "white", alignItems: "center", justifyContent: "center" }}>
